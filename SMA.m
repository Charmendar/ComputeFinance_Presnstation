...
for day_index_2=1:Day_count
    if day_index_2<=Interval
        ...
        Total_Value_Actual(day_index_2)=SMA_BaBa(day_index_2)*Num_BaBa(day_index_2)+SMA_IBM(day_index_2)*Num_IBM(day_index_2)+SMA_TSLA(day_index_2)*Num_TSLA(day_index_2);
    else
...
hold off
legend('show','Expected Total Worth','Actual Total Worth')
xlabel('Days')
